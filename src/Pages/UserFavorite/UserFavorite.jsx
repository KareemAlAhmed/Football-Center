...
export default function UserFavorite() {
  ...
  if(currentUser.favTeams.length >=1){
    navigate("/")
  }
  const getCompetetions= async ()=>{
    dispatch(GET_TOURNS_BY_CAT())
  }
                  ...
                  {ele.leagues.map((league,index)=>{
                    return <div className="competetion" key={index} onClick={()=>getLeagueTeams(league)}>
                              <div className="competetionImg">
                                <img src={league.id != null ? league.leagueLogo : "https://a.espncdn.com/combiner/i?img=/i/teamlogos/soccer/500/default-team-logo-500.png&w=80&h=80&scale=crop&cquality=40&location=origin"} alt="" />
                              </div>
