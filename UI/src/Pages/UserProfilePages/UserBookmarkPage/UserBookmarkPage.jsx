...
import UserBookMarks from "../../../components/UserComponents/UserBookMarks/UserBookMarks";
...
export default function UserBookmarkPage() {
    ...
    return (
      <>
          <NavBar />
          <div className="userPage userBookmarksPage">
              ...
              {loading ? (
                    ...
                    <>
                        ...
                        <div className="pageContent">
                            <UserBookMarks userData={currentUser} />
